...
export default async function ProductDetailPage({ params }: PageProps) {
  ...
  // Combine mainImage and gallery items into a single array, filtering out invalid assets
  const allImages = [
    product.mainImage,
    ...(product.gallery || [])
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
        {/* Left Column: Vertical Stacked Images (Original Size, Uncropped) */}
        {allImages.length > 0 && (
